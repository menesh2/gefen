...
class FlickerManager{
    ...
    static let photoUrlpattern = "https:\\\\farm{farm}.staticflickr.com\\{server}\\{id}_secret_m.jpg"
    ...
    static func getPhoto(imageData:ImageData, completionCallback:@escaping (ImageData)->() ) {
        ...
        let photoUrl = "https://farm\(imageData.farm).staticflickr.com/\(imageData.server)/\(imageData.imageId)_\(imageData.secret)_m.jpg"
